    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Header paragraph style",
            link: "/Header-paragraph-style.md",
          },
          { text: "Markdown table style", link: "/Markdown table style.md" },
          {
            text: "Neuracache flashcard style",
            link: "/Neuracache-flashcard-style.md",
          },
          { text: "Question answer style", link: "/Question-answer-style.md" },
          {
            text: "RemNote single-line style",
            link: "/RemNote single-line style.md",
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Updating existing notes",
            link: "/Updating existing notes.md",
          },
        ],
      },
    ],
